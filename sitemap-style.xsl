            ...
            <body class="ph3 pb3 mid-gray">
                <header class="mw8 pv4 center">
                    <div class="flex items-center">
                        <h1 class="ma0 mr2 f2 blue">Sitemap de los Sitemaps</h1>
                ...
                <footer class="mw8 center pv4 tc">
                    XML Sitemap generado manualmente por <a href="https://franperezg.com" title="Francisco Perez" class="link blue">Francisco Perez</a>
                </footer>
