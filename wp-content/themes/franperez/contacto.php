               ...
               <section class="s-pageheader pageheader">
                    <div class="row">
                        <div class="column xl-12">
                            <h1 class="page-title">
                                <span class="page-title__small-type text-pretitle">Contacto</span>
                                ¿Listo para optimizar<br> tu sitio web?
                            </h1>                            
                        </div>
                    </div>
               </section> <!--pageheader -->  
                        ...
                        <div class="column xl-12">
                            ...
                            <div class="row">
                                ...
                                <div class="column xl-5 md-12 u-flexitem-x-right">
                                    ...
                                    <div class="contact-block">
                                        <h6>Email</h6>
                                        <a href="mailto:hola@franperezg.com">hola@franperezg.com</a>
                                    </div>
                                    <div class="contact-block">
                                        <h6>Teléfono</h6>
                                        <ul class="contact-list">
                                            <li><a href="tel:+44 7563 842 900">+44 7563 842 900</a></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
