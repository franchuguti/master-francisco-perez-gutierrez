<?php include_once 'components/header.php'; ?>
        ...
        <section id="content" class="s-content">
                    ...
                    <div class="column lg-12 s-intro__content-inner grid-block">
                        ...
                        <div class="s-intro__content-media"> 
                            <div class="s-intro__content-media-inner">                               
                                <img src="/wp-content/themes/franperez/images/Francisco-perez-portrait.webp" title="Retrato de Francisco Perez" alt="Retrato de Francisco Perez">
                                <div class="lines">                               
                                    <span></span>                                  
                                </div>
                            </div>
                        ...
                        <div class="s-intro__scroll-down">
                            <a href="#sobremi" class="smoothscroll">
            ...
            <!-- about
            ----------------------------------------------- -->
            <section id="sobremi" class="s-about target-section">
                    ...
                    <div class="column grid-block grid-section-split">
                        ...
                        <div class="section-header grid-section-split__header">
                            ...
                            <h2 class="text-display-title">
                                Impulsando marcas a través de la búsqueda.
                            </h2>                           
